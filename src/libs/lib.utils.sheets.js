 ...
 * @return {SpreadSheet}
 */
SheetsUtilitiesLibrary.prototype.getCurrentActiveLogSpreadsheet = function() {
  var loadLocal = ((typeof this.config.sheets !== 'undefined') &&
      (typeof this.config.sheets.logSpreadsheetId !== 'undefined') &&
      (this.config.sheets.logSpreadsheetId !== ''));
  if (loadLocal) {
    return SpreadsheetApp.openById(this.config.sheets.logSpreadsheetId);
  } else {
    return SpreadsheetApp.getActiveSpreadsheet();
  }
};
