 ...
 *     The current configuration settings, updated with dev settings.
 */
 function provideEnvironmentConfiguration_(configuration) {
  configuration.sheets.debugSpreadsheetId = '17_EIZg2wIlpRhPrUAQufcobwFJUmdbtpjtp_2lRE8SI';
  configuration.logSpreadsheetId = '1nkNr-7RO5YrowGSs-6KfqIMxipTb2VoHIAn2b3G9PIo';
